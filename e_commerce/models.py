...
class Comic(models.Model):
    ...
    class WishList(models.Model):
        ...
        IdComic = models.ForeignKey("Comic", verbose_name=("IdComic"), on_delete=models.CASCADE)
        favorite = models.CharField(verbose_name="favorite" , max_length=50, default="")
        cart = models.PositiveIntegerField(verbose_name="cart", default=0)
        wished_qty = models.PositiveIntegerField(verbose_name="wished_qty", default=0)
        bought_qty = models.PositiveIntegerField(verbose_name="bought_qty", default=0)
